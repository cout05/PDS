                            ...
                            <div class="space-y-4">
                                <template x-for="(decl, index) in declarations" :key="index">
                                    <div class="border p-4 rounded mb-4">
                                        <p class="text-sm font-medium mb-2" x-text="decl.question_no + '.'"></p>
                                        <input type="hidden" :name="'declarations['+index+'][question_no]'" x-model="decl.question_no">
                                        <div class="ml-4 space-y-2">
                                            <label><input type="radio" :name="'declarations['+index+'][answer]'" x-model="decl.answer" value="Yes"> Yes</label>
                                            <label><input type="radio" :name="'declarations['+index+'][answer]'" x-model="decl.answer" value="No"> No</label>
                                            <input type="text" :name="'declarations['+index+'][details]'" x-model="decl.details" placeholder="If YES, give details" class="mt-1 block w-full rounded border-gray-300 text-sm">
                                        </div>
                                    </div>
                                </template>
                            </div>
