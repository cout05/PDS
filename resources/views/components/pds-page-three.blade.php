<div class="page">
    <div class="section-header">VI. VOLUNTARY WORK OR INVOLVEMENT IN CIVIC / NON-GOVERNMENT / PEOPLE / VOLUNTARY
        ORGANIZATION/S</div>
...
>>>>>>> 2a0bc891da27e4715348feff54930e414d652d77
    ...
    <table class="centered-data">
        <tr>
            <th rowspan="2" style="width: 20%;">30. TITLE OF LEARNING AND DEVELOPMENT INTERVENTIONS/TRAINING PROGRAMS
                (Write in full)</th>
...
>>>>>>> 2a0bc891da27e4715348feff54930e414d652d77
    ...
    <table class="centered-data">
        ...
        @for ($i = 0; $i < 7; $i++)
            <tr>
                <td><textarea class="input-text" :value="(other_info.skills || '').split('\n')[{{ $i }}]"
                        readonly></textarea></td>
                <td><textarea class="input-text" :value="(other_info.recognitions || '').split('\n')[{{ $i }}]"
                        readonly></textarea></td>
                <td><textarea class="input-text" :value="(other_info.memberships || '').split('\n')[{{ $i }}]"
                        readonly></textarea></td>
            </tr>
        @endfor
        <th colspan="8" style="text-align: center; color: red;">continue on seperate sheet if necessary</th>
